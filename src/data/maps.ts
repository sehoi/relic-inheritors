 ...
 */
export const MAP_IDS = ['ruin-entrance', 'ruin-depths', 'ruin-sanctum', 'haven'] as const;
...
export const MAP_FILES: Readonly<Record<MapId, string>> = {
  ...
  'ruin-sanctum': 'src/data/maps/ruin-sanctum.tmj',
  haven: 'src/data/maps/haven.tmj',
};
